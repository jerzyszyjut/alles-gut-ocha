...
\hypersetup{
  ...
  urlcolor=ocha-blue,
  citecolor=ocha-blue,
  pdftitle={Humanitarian Crisis Neglect Index With Uncertainty Quantification and Counterfactual Reasoning - Technical Documentation},
  pdfauthor={Alles GUT},
}
...
\begin{titlepage}
  \centering
  \vspace*{3cm}
  {\Huge\bfseries\color{ocha-blue} Humanitarian Crisis Neglect Index With Uncertainty Quantification and Counterfactual Reasoning\par}
  \vspace{0.5cm}
